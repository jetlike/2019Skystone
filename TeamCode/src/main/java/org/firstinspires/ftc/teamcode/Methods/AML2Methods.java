...
public class AML2Methods extends LinearOpMode {
    ...
    public void MoveInch(double speed, double inches, int timeoutS) {
        while (opModeIsActive() && !isStopRequested()) {
            ...
            while (Math.abs(leftBack.getCurrentPosition()) <= ticks - stopVal  && opModeIsActive()) {
                double error = (ticks - rightBack.getCurrentPosition()) / (560 / (2.95275590551));
                ...
                telemetry.addData("MotorPow:",ChangeP);
              //  if (ChangeP < .0) {
